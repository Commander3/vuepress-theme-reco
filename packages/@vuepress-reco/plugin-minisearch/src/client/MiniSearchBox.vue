...
debouncedWatch(
  () => [filterText.value, showDetailedList.value] as const,
  async ([filterTextValue, showDetailedListValue], old, onCleanup) => {
    ...
    // Search
    // @ts-ignore
    results.value = search(filterTextValue)
      ...
      <div class="shell">
        ...
        >
          ...
          <div class="search-actions before">
            <button
              class="back-button"
              :title="infoModal.backButtonTitle"
              @click="$emit('close')"
            >
          ...
          <div class="search-actions">
            <button
              ...
              :title="infoModal.displayDetails"
              @click="
            ...
            <button
              ...
              :title="infoModal.resetButtonTitle"
              @click="resetSearch"
            >
        ...
        >
          ...
          <li
            ...
            class="no-results"
          >
            {{ infoModal.noResultsText }} "<strong>{{ filterText }}</strong
            >"
          </li>
        </ul>
        ...
        <div class="search-keyboard-shortcuts">
          <span>
            <kbd :aria-label="infoModal.footer.navigateUpKeyAriaLabel">
              <span class="vpi-arrow-up navigate-icon" />
            </kbd>
            <kbd :aria-label="infoModal.footer.navigateDownKeyAriaLabel">
              <span class="vpi-arrow-down navigate-icon" />
            </kbd>
            {{ infoModal.footer.navigateText }}
          </span>
          <span>
            <kbd :aria-label="infoModal.footer.selectKeyAriaLabel">
              <span class="vpi-corner-down-left navigate-icon" />
            </kbd>
            {{ infoModal.footer.selectText }}
          </span>
          <span>
            <kbd :aria-label="infoModal.footer.closeKeyAriaLabel">esc</kbd>
            {{ infoModal.footer.closeText }}
          </span>
        </div>
      </div>
    </div>
